...
/* ----------------------------- Metadata ------------------------------ */
group = "net.true-og.DiamondBank-OG-PAPI"

version = "1.0.8"

val apiVersion = "1.19"

eclipse { project { name = "DiamondBank-OG-PAPI-Plugin" } }
...
repositories {
    ...
    maven { url = uri("https://hub.spigotmc.org/nexus/content/repositories/snapshots/") } // TODO: Remove
}

/* ---------------------- Java project deps ---------------------------- */
dependencies {
    compileOnly("org.purpurmc.purpur:purpur-api:1.19.4-R0.1-SNAPSHOT")
    // TODO: Remove AFKPlus API.
